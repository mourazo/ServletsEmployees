...
public class Incidencia implements Serializable {
    ...
    public Incidencia(Integer idincidencia, String fechahora, String detalle, String tipo) {
        ...
        public Incidencia(String fechahora, String detalle, String tipo) {
        this.fechahora = fechahora;
        this.detalle = detalle;
        this.tipo = tipo;
     ...
     public Incidencia(String fechahora, String detalle, String tipo, Empleado origen, Empleado destino) {
        this.idincidencia = idincidencia;
        this.fechahora = fechahora;
        this.detalle = detalle;
        this.tipo = tipo;
   ...
   public Integer getIdincidencia() {
    ...
    public String toString() {
        return "clasesIncidencias.Incidencia[ idincidencia=" + idincidencia + " ]";
    }
