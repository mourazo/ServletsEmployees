 ...
 * @author alvar
 */
@WebServlet(name = "ServletObtenerIncidenciaParaEmpleado", urlPatterns = {"/ServletObtenerIncidenciaParaEmpleado"})
public class ServletObtenerIncidenciaParaEmpleado extends HttpServlet {
@EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         ...
         try (PrintWriter out = response.getWriter()) {
            List<Incidencia> in = incidenciasEJB.findIncidenciasByEmpleadoOrigen(empleado);
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>ServletObtenerIncidenciaParaEmpleado</title>");            
            out.println("</head>");
            out.println("<body>");    
           ...
           out.println("<h1>Listado de incidencias para el empleado " +empleado +" </h1>");
