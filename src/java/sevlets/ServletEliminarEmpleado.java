    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
           try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>ServletEliminarEmpleado/title>");            
            out.println("</head>");
            out.println("<body>");
            String nombre = request.getParameter("nombre");

            
            Empleado empl = new Empleado(nombre);
            if (incidenciasEJB.eliminarEmpleado(empl)) {
                out.println("EMPLEADO "+ nombre +" ELIMINADO CON ÉXITO");
            } else {
