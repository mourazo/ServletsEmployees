 ...
 * @author alvar
 */
@WebServlet(name = "ServletUpdatePassword", urlPatterns = {"/ServletUpdatePassword"})
...
IncidenciasEJB incidenciasEJB;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>ServletUpdateContraseña</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            if (incidenciasEJB.updateContraseña(empl)) {
                out.println("CONTRASEÑA DEL USUARIO "+ nombre +" MODIFICADA CON ÉXITO");
            } else {
